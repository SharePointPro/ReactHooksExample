  ...
  return (
    <div className="container">
      ...
      <section className="content">
        {globalContext.starwarsItems.isFetching && <Loader />}
        {!globalContext.starwarsItems.isFetching &&
          globalContext.starwarsItems.items &&
          globalContext.starwarsItems.items.length === 0 && <h2>No Results</h2>}
        {globalContext.starwarsItems.items &&
          globalContext.starwarsItems.items.length > 0 && (
            <Results items={globalContext.starwarsItems.items} />
          )}
        <div className="tagline">
          Built and designed by <a href="http://www.aponyx.io">aponyx</a> using
          React / Redux.&nbsp;
          <a href="https://github.com/aponyx/swapi-react">
